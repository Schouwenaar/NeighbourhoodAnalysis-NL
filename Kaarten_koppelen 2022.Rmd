...
GezondheidStress2022$buurtcode <- GezondheidStress2022$Codering_3
GezondheidStress2022$Codering_3 <- NULL

GezondheidStress2022 <- GezondheidStress2022 %>%
  filter(
    Marges == "MW00000"
  )

GezondheidStress2022$Marges <- NULL
GezondheidStress2022$buurtcode <-
  trimws(
    GezondheidStress2022$buurtcode
  )
...
GezondheidStress2022 <- GezondheidStress2022 %>%
  rename(
    ErvarenGezondheidGoedZeerGoed_2022 = ErvarenGezondheidGoedZeerGoed_4,
    PsychischeKlachten_2022 = PsychischeKlachten_20,
    HoogRisicoOpAngstOfDepressie_2022 = HoogRisicoOpAngstOfDepressie_25,
    HeelVeelStressInAfgelopen4Weken_2022 = HeelVeelStressInAfgelopen4Weken_26
  )

buurtenStress <- buurtenStress %>% merge(GezondheidStress2022,
  by = "buurtcode",
  all.x = TRUE,
  all.y = FALSE
)
